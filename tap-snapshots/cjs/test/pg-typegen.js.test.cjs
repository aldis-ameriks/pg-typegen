 ...
 */
'use strict'
exports['cjs/test/pg-typegen.js > TAP > allows hooking into schema result > must match snapshot 1'] = `
Object {
  "enums": Array [
    Object {
...
exports['cjs/test/pg-typegen.js > TAP > allows hooking into type result > must match snapshot 1'] = `
Object {
...
exports['cjs/test/pg-typegen.js > TAP > generates types as return value > must match snapshot 1'] = `
export enum DeliciousKebab {
  'big-mix' = 'big-mix',
  mix = 'mix',
}
...
exports['cjs/test/pg-typegen.js > TAP > generates types to file > must match snapshot 1'] = `
export enum DeliciousKebab {
  'big-mix' = 'big-mix',
  mix = 'mix',
}
...
exports['cjs/test/pg-typegen.js > TAP > generates types with comments and insert types > must match snapshot 1'] = `
export enum DeliciousKebab {
  'big-mix' = 'big-mix',
  mix = 'mix',
}
...
exports['cjs/test/pg-typegen.js > TAP > generates types with insert types > must match snapshot 1'] = `
export enum DeliciousKebab {
  'big-mix' = 'big-mix',
  mix = 'mix',
}
...
exports['cjs/test/pg-typegen.js > TAP > generates types with optionals and with table name prefix > must match snapshot 1'] = `
export enum DeliciousKebab {
  'big-mix' = 'big-mix',
  mix = 'mix',
}
...
exports['cjs/test/pg-typegen.js > TAP > generates types with table name prefix > must match snapshot 1'] = `
export enum DeliciousKebab {
  'big-mix' = 'big-mix',
  mix = 'mix',
}
...
exports['cjs/test/pg-typegen.js > TAP > returns help when missing connection > must match snapshot 1'] = `
undefined
`

exports['cjs/test/pg-typegen.js > TAP > returns help when missing connection > must match snapshot 2'] = `
undefined
`
