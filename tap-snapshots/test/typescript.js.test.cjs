...
export type Tables = 'known' | 'unknown' | 'snake_case' | 'kebab-case' | 'white space' | 'custom' | 'empty' | 'excluded' | 'apples' | 'addresses' | 'entities' | 'UpperCase' | 'defaults_no_columns' | 'defaults';
