...
exports['test/typescript.js > TAP > viewNames with single view > must match snapshot 1'] = `
...
exports['test/typescript.js > TAP > viewNames with views > must match snapshot 1'] = `
...
exports['test/typescript.js > TAP > viewNames without views > must match snapshot 1'] = `
export enum Apples {}
